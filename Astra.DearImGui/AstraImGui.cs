...
public static class AstraImGui
{
    public enum Variant
    {
        Default,
    ...
    private static void UseSpecificRuntime(IntPtr nativeRuntimeHandle)
    {
        ...
        NativeLibrary.SetDllImportResolver(typeof(AstraImGui).Assembly, DllImportResolver);
    }
    ...
    {
        string variantPath = "Astra.DearImGui.Native";
        ...
        if (NativeLibrary.TryLoad(variantPath, typeof(AstraImGui).Assembly, DllImportSearchPath.ApplicationDirectory, out IntPtr handle))
